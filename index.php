...
<html lang="nl">
<head>
    <title>GOALR.app | Life changing GOALsetteR</title>
    <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-12 col-sm-12 col-xs-12"
                        ...
                        <p>GOALR <a href="#">HTML landing page</a>
                    ...
                    <ul>
                        ...
                        <li data-scroll-reveal="enter right move 30px over 0.6s after 0.5s">
                            ...
                            <div class="text">
                                ...
                                <p>Duis viverra, ipsum et scelerisque placerat, orci magna consequat ligula.</p>
                            </div>
                        </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="sub-footer">
                        <p>Copyright &copy; 2021 GAOLR.app promotional website</p>
                    </div>
                </div>
            </div>
        </div>
